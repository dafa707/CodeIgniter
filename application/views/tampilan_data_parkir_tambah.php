  ...
  <main class="container">
    <form action="<?=base_url()?>index.php/DataParkir/tambah_proses" method="post">
      <div class="mb-3">
        ...
        <input type="text"
          class="form-control" name="plat_nomor" id="" aria-describedby="plat_nomor" placeholder="">
      </div>
      <div class="mb-3">
        <label for="" class="form-label">Jenis Kendaraan</label>
        <input type="text"
          class="form-control" name="jenis_kendaraan" id="" aria-describedby="jenis_kendaraan" placeholder="">
      </div>
