...
<body>
  ...
  <main class="container">
    <form action="<?=base_url()?>index.php/DataParkir/edit_proses/<?=$data->id_transaksi?>" method="post">
      <div class="mb-3">
        <label for="" class="form-label">Plat Nomor</label>
        <input type="text"
          class="form-control" name="plat_nomor" id="" aria-describedby="plat_nomor" placeholder="" value="<?=$data->plat_nomor?>">
      </div>
      <div class="mb-3">
        <label for="" class="form-label">Jenis Kendaraan</label>
        <input type="text"
          class="form-control" name="jenis_kendaraan" id="" aria-describedby="jenis_kendaraan" placeholder="" value="<?=$data->jenis_kendaraan?>">
      </div>
