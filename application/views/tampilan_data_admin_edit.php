...
<body>
  ...
  <main class="container">
    <form action="<?=base_url()?>index.php/DataAdmin/edit_proses/<?=$data->id_admin?>" method="post">
      <div class="mb-3">
        <label for="" class="form-label">Nama</label>
        <input type="text"
          class="form-control" name="nama" id="" aria-describedby="nama" placeholder="" value="<?=$data->nama?>">
      </div>
      <div class="mb-3">
        <label for="" class="form-label">Username</label>
        <input type="text"
          class="form-control" name="username" id="" aria-describedby="username" placeholder="" value="<?=$data->username?>">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text"
          class="form-control" name="jabatan" id="" aria-describedby="jabatan" placeholder="" value="<?=$data->jabatan?>">
      </div>
